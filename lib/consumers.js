...
var get = function (group, id, callback) {
    ...
    add = function (consumer, callback) {
        ...
        consumer.byteSize = 0;
        consumer.offsetMap = [];
        consumer.requestMaxMessages = consumer.requestMaxMessages || config.consumer.requestMaxMessages;
    ...
    createOffsetItem = function(message) {
        ...
        return {
            ...
            offset : (typeof message.offset !== 'undefined') ? message.offset + 1 : 0,
            metadata : 'm'
        };
    },
    ...
    getMessages = function (consumer, callback) {
        ...
        var messages = consumer.messages.slice(0, consumer.requestMaxMessages);
