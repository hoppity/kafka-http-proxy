...
var publish = function(producer, payloads, callback) {
    ...
    payloads.forEach(function (p) {
        ...
        var existing = payloadsToPublish.filter(function (m) {
    ...
    logger.trace({payloads: payloadsToPublish}, 'transformed payloads. publishing...');
